...
3. **Risk Map, switch to Historical mode** — drag the year slider from 2007 → 2016, narrate: _"These are 368 real, verified landslide events across NER — not simulated"_
