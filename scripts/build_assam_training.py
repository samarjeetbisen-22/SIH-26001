"""
Assam Training Dataset Builder
...
Output: data/processed/training/assam/assam_training.csv
"""
...
LABEL_MASK  = "data/processed/labels/assam/assam_label_mask.tif"
LITH_GPKG   = "data/processed/lithology/assam/assam_lithology.gpkg"
OUT_DIR     = "data/processed/training/assam"
OUT_CSV     = os.path.join(OUT_DIR, "assam_training.csv")
RANDOM_SEED = 42

os.makedirs(OUT_DIR, exist_ok=True)

print("=" * 60)
print("Assam Training Dataset Builder")
print("=" * 60)
