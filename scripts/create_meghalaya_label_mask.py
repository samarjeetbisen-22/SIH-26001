"""
Meghalaya Label Mask Creation
Buffers 39 landslide event points with 150m circular buffer.
Rasterizes onto 30m master grid.
Outputs:
- data/processed/labels/meghalaya/meghalaya_label_mask.tif
- data/processed/labels/meghalaya/meghalaya_event_buffers.gpkg
"""
...
EVENTS_CSV = "data/raw/landslides/meghalaya_events.csv"
REF_RASTER = "data/processed/factors/meghalaya/meghalaya_elevation.tif"
OUT_DIR    = "data/processed/labels/meghalaya"
OUT_MASK   = os.path.join(OUT_DIR, "meghalaya_label_mask.tif")
BUFFER_M   = 150

os.makedirs(OUT_DIR, exist_ok=True)

print("=" * 60)
print("Meghalaya Label Mask Creation")
print(f"Buffer radius: {BUFFER_M} m")
print("=" * 60)

events = pd.read_csv(EVENTS_CSV)
print(f"Loaded {len(events)} Meghalaya events")
...
event_gpkg = os.path.join(OUT_DIR, "meghalaya_event_buffers.gpkg")
